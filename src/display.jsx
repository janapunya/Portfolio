        ...
        <div className=' mt-10 px-15 work_container' id='work'>
          ...
          <div className='card grid gap-3'>
            ...
            <TiltedCard
              ...
              overlayContent={
                <a href='https://trendnest-ydh9.onrender.com' 
                   target="_blank" 
                   rel="noopener noreferrer"
                   aria-label="View Trendnest project">
                  <p className="tilted-card-demo-text ml-15 mt-40 bg-zinc-800 p-1 rounded-xl">
                    Check Project
                  </p>
                </a>
              }
            ...
            <TiltedCard
              ...
              displayOverlayContent={true}
              overlayContent={
                <a href='https://janapunya.github.io/Bike-website/' 
                   target="_blank" 
                   rel="noopener noreferrer"
                   aria-label="View Bike website project">
                  <p className="tilted-card-demo-text ml-15 mt-40 bg-zinc-800 p-1 rounded-xl">
                    Check Project
                  </p>
                </a>
